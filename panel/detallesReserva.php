                            ...
                            <div class="p-5">
                                ...
                                <form action="controlador/editarReserva.php" method="POST">
                                        <?php
                                            ...
                                            $id=$_GET['id'];
                                            $sql = $conexion->query("SELECT * FROM reserva r JOIN usuario u ON r.usuario_idu = u.id JOIN estado e ON r.estado_id_estado = e.id_estado WHERE idr=$id");
                                            $resultado = $sql->fetch_assoc();
                                        ?>
                                   <div class="form-group row">
                                        <div class="col-sm-6">
                                            <imput type="text" class="form-control" value="<?php echo $resultado['nombres']; ?>" >
                                        </div>
                                        <div class="col-sm-6">
                                            <imput type="text" class="form-control" value="<?php echo $resultado['apellidos']; ?>" >
                                        </div>
                                    </div>
                                   <div class="form-group row">
                                        <div class="col-sm-6">
                                            <select name="cantidad" class="form-control">
                                                <option selected><?php echo $resultado['cantidad']; ?></option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6"> 
                                            <input type="date" value="<?php echo $resultado['fechar']; ?>" class="form-control" name="fecha" placeholder="Fecha">
                                        </div>
                                    </div>
                                    <br>    
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <select name="tipo"  class="form-control">
                                                <option selected><?php echo $resultado['tipo']; ?></option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="time" value="<?php echo $resultado['hora']; ?>" name="hora" class="form-control">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <textarea name="comentario"  class="form-control" placeholder="Comentario / Recomendaciones" rows="3"><?php echo $resultado['comentario']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <imput class="form-control" value="<?php echo $resultado['nestado']; ?>">
                                        </div>
                                    </div>
                                    <br><hr>
                                </form>
