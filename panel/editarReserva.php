                            ...
                            <div class="p-5">
                                ...
                                <form action="controlador/editarReserva.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="time" value="<?php echo $row['hora']; ?>" name="hora" class="form-control">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <textarea name="comentario"  class="form-control" placeholder="Comentario / Recomendaciones" rows="3"><?php echo $row['comentario']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
