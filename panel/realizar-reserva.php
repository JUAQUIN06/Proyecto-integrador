                        ...
                        <div class="col-lg-8">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">REALIZAR RESERVA</h1>
                                </div>
                                <form action="controlador/guardarReserva.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <textarea name="comentario"  class="form-control" placeholder="Comentario / Recomendaciones" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
